...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ansi_regular_shift_regular_backspace(
        ...
        KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,            MO(_FN), KC_UP,   KC_NO,
    ...
    [_FN] = LAYOUT_ansi_regular_shift_regular_backspace(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9, KC_F10,    KC_F11, KC_F12, KC_INS,            KC_PSCR,   KC_SLCK, KC_PAUS,
        KC_NO,      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP, KC_NO, KC_DEL,          KC_INSERT, KC_HOME, KC_PGUP,
        _______,     KC_VOLD, KC_VOLU, KC_MUTE, KC_EJCT, KC_NO, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RIGHT, KC_NO,  KC_DELETE, KC_END,  KC_PGDN,
        _______,         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PPLS, KC_PMNS, KC_END, KC_PGDN, KC_DOWN, _______,               _______,   KC_NO,   KC_NO,
        _______, _______, _______,                             MO(_FN2),                       _______, KC_NO, _______,        KC_NO,     KC_NO,   KC_NO
    ),
