...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Base */
    [_BASE] = LAYOUT_ansi_nonhhkb_split_shift_split_backspace(
        ...
        KC_LCTRL,     KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,            KC_P1,   KC_P2,   KC_P3,
        KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(_FN),   KC_P0,   KC_UP,   KC_PDOT,
        KC_CAPS, KC_LGUI, KC_LALT,                      KC_SPC,                  KC_RALT, KC_NLCK, KC_RCTRL,     KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [_FN] = LAYOUT_ansi_nonhhkb_split_shift_split_backspace(
        ...
        _______,         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PPLS, KC_PMNS, KC_END, KC_PGDN, KC_DOWN, _______, _______,      KC_INS,    KC_NO,   KC_DEL,
        _______, KC_NO, _______,                             MO(_FN2),                           _______, KC_NO, _______,      KC_NO,     KC_NO,   KC_NO
    ),
    [_FN2] = LAYOUT_ansi_nonhhkb_split_shift_split_backspace(
