...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Base */
    [_BASE] = LAYOUT_iso_nonhhkb_split_shift_split_backspace(
    ...
    [_FN] = LAYOUT_iso_nonhhkb_split_shift_split_backspace(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9, KC_F10,    KC_F11, KC_F12, KC_INS, KC_DEL,    KC_HOME,   KC_UP,   KC_PGUP,
        KC_NO,      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP, KC_NO, KC_BSPC,         KC_LEFT,   KC_NO,   KC_RIGHT,
    ...
    [_FN2] = LAYOUT_iso_nonhhkb_split_shift_split_backspace(
